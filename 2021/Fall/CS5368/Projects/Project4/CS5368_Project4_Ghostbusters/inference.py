...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        pNoisyGvnTrue = busters.getObservationProbability(noisyDistance, trueDistance)
        return pNoisyGvnTrue
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        repeat = int(self.numParticles / len(self.legalPositions))
    ...
    def elapseTime(self, gameState):
        ...
        # raiseNotDefined()
        tmp = []
        for idx, oldPos in enumerate(self.particles):
            tmp.append(self.getPositionDistribution(gameState, oldPos).sample())
